...
const Menu1 =  () => {
  ...
  return (
    <>
      {/* Navbar */}
      <nav className={`w-full text-center py-0 ${hiddenOnMd ? 'hidden md:block' : 'md:block'}`}>
        <ul className={`flex justify-center  space-x-4  text-black  ${hiddenOnMd ? 'items-center' : 'flex-col border-b-2'}`}>
          <li  className={`group  max-lg:px-3 md:py-1 relative ml-1 py-2 `}>
            <a href="#" className="text-sm hover:text-gray-600 flex items-center justify-between nav-link">
          ...
          <li className={`group relative py-2`}>
            <a href='javascript:void(0)'
              className={`hover:text-[#007bff] hover:fill-[#007bff]  text-sm flex items-center justify-between  `}>
                <span>
                  {
                    hiddenOnMd ? "" : <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" class="mr-4 inline-block"
                    viewBox="0 0 64 64">
            ...
            <ul
              class='absolute top-5 max-lg:top-8 left-0 z-50 block space-y-1 shadow-lg bg-white max-h-0 overflow-hidden min-w-[250px] group-hover:opacity-100 group-hover:max-h-[700px] px-0 group-hover:pb-0 group-hover:pt-4 transition-all duration-500'>
              <li class='border-b py-2'>
                <a href='javascript:void(0)'
                  class='hover:text-[#007bff] hover:fill-[#007bff] text-sm block nav-link'>
              ...
              <li class='border-b py-3'>
                <a href='javascript:void(0)'
                  class='hover:text-[#007bff] hover:fill-[#007bff] text-sm block'>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" class="mr-4 inline-block"
          ...
          <li className="py-2">
            <a href="#" className="text-sm hover:text-gray-600 flex items-center justify-between">
              <span>
                {
                  hiddenOnMd ? "" :    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" class="mr-4 inline-block"
                  viewBox="0 0 64 64">
