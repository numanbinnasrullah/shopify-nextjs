  ...
  return (
    <div class="font-[sans-serif] max-w-6xl mx-auto p-4 mb-10">
      <div class="bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] p-8">
        ...
        <form class="space-y-3 max-w-xl mx-auto text-gray-800" onSubmit={handleSubmit}>
          ...
          />
           <textarea
            ...
            placeholder="Message"
            rows="12"
            className="w-full border rounded px-4 text-sm pt-3 focus:outline-slate-600"
            value={formData.message}
            onChange={handleChange}
          ></textarea>
          <button
              type="submit"
              className="text-white w-full bg-slate-900 hover:bg-slate-700 rounded text-sm px-6 py-3 !mt-6"
            >
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 mt-12">
          <div class="flex flex-col items-center bg-white">
            ...
            <div class="mt-4 text-center">
              <h4 class="text-gray-800 text-base font-bold">Address</h4>
              <p class="text-sm text-gray-500 mt-2"> 123 Main Street, City, Country</p>
            </div>
          </div>
          ...
          <div class="flex flex-col items-center bg-white">
            ...
            <div class="mt-4 text-center">
              ...
              <p class="text-sm text-gray-500 mt-2"> +158 996 888</p>
            </div>
          </div>
          ...
          <div class="flex flex-col items-center bg-white">
            ...
            <div class="mt-4 text-center">
              ...
              <p class="text-sm text-gray-500 mt-2">info@example.com</p>
            </div>
          </div>
          ...
          <div class="flex flex-col items-center bg-white">
            ...
            <div class="mt-4 text-center">
              <h4 class="text-gray-800 text-base font-bold">Company Registration</h4>
              <p class="text-sm text-gray-500 mt-2">11571226</p>
            </div>
          </div>
